...
public abstract class FileValidator {
	 ...
	 * @return 校验结果
	 */
	public abstract FileValidateResult validateFile(MultipartFile file, String name);
	 ...
	 * @return 校验结果
	 */
	protected FileValidateResult passToNext(MultipartFile file, String name) {
		if (next == null) {
			return FileValidateResult.resultSuccess("全部文件规则校验通过！");
		}
		return next.validateFile(file, name);
	}
